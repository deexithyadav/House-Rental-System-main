...
<div class="row">
  ...
  <?php } else { ?>
    <input type="submit" class="btn btn-lg btn-primary" style="width: 100%" value="Property Blocked. Contact the owner for further negotiations and payment procedure." disabled>
  <?php } ?>
  </div>
</form>
